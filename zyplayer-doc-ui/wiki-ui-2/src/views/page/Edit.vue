<template>
  <div style="height: 100%" class="page-edit-vue">
    <div style="box-sizing: border-box; background: #f5f5f5; overflow: hidden">
        ...
        <el-row>
          <el-col :span="16">
            <template v-if="pageId">
              <span>编辑方式：</span>
              <el-select
                v-model="wikiPageEdit.editorType"
                v-on:change="editorTypeChange"
                :disabled="!!pageId"
                size="mini"
              >
          ...
          <el-col :span="8" style="text-align: right">
            <el-button
              type="primary"
              v-on:click="createWikiSave(1)"
              size="mini"
              :icon="ElIconDocumentChecked"
              >保存并查看</el-button
            >
            <el-button
              type="success"
              v-on:click="createWikiSave(0)"
              size="mini"
              :icon="ElIconCheck"
              >仅保存</el-button
            >
            <el-button
              v-on:click="createWikiCancel"
              size="mini"
              :icon="ElIconBack"
              >取消</el-button
            >
      ...
      <div
        v-show="wikiPageEdit.editorType === 2"
        style="padding: 0 10px 10px 10px; background: #fff"
      >
        <el-input
          v-model="wikiPageEdit.pageTitle"
          placeholder="请输入标题"
  ...
  data() {
    return {
      ...
      fileUploadUrl:
        ...
        '/zyplayer-doc-wiki/page/file/wangEditor/upload',
