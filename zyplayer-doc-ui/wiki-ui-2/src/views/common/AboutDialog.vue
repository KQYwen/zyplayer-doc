<template>
  ...
  <el-dialog
    ...
    width="600px"
    custom-class="about-zyplayer-doc"
  >
    <div style="">
      ...
      <el-tabs type="border-card">
        <el-tab-pane label="支持">
          <div style="line-height: 30px">
            <div>
              文档：<a
                target="_blank"
                href="http://doc.zyplayer.com/doc-wiki#/docs/w4eSzPWvQRSBvaCHZS8t6d"
                >http://doc.zyplayer.com</a
              >
            </div>
            <div>
              主页：<a
                ...
                >https://gitee.com/zyplayer/zyplayer-doc</a
              >
            </div>
            <div>
              反馈：<a
                target="_blank"
                href="https://gitee.com/zyplayer/zyplayer-doc/issues"
                >https://gitee.com/zyplayer/zyplayer-doc/issues</a
              >
            </div>
        ...
        <el-tab-pane label="开源软件">
          <div style="line-height: 30px">
            ...
            <div>
              ...
              <a target="_blank" href="https://github.com/alibaba/druid"
                >Druid</a
              >、
              <a target="_blank" href="https://mp.baomidou.com">MyBatis-Plus</a
              >、 <a target="_blank" href="https://www.hutool.cn">Hutool</a>、
              <a target="_blank" href="https://github.com/alibaba/fastjson"
                >Fastjson</a
              >、
              <a target="_blank" href="https://alibaba-easyexcel.github.io"
                >Easy Excel</a
        ...
        <el-tab-pane label="软件更新" v-if="upgradeInfo.lastVersion">
          ...
          <div style="line-height: 30px">
            ...
            <div>
              升级地址：<a target="_blank" :href="upgradeInfo.upgradeUrl">{{
                upgradeInfo.upgradeUrl
              }}</a>
            </div>
            <div>升级内容：</div>
            <pre style="margin: 0; max-height: 250px; overflow: auto">{{
      ...
      systemApi.systemUpgradeInfo({}).then((json) => {
        if (!!json.data) {
          ...
          if (!!this.upgradeInfo.upgradeContent) {
            this.upgradeInfo.upgradeContent =
              this.upgradeInfo.upgradeContent.replaceAll('；', '\n')
            console.log(
              'zyplayer-doc发现新版本：' +
                '\n升级地址：' +
                json.data.upgradeUrl +
                '\n当前版本：' +
                json.data.nowVersion +
                '\n最新版本：' +
                json.data.lastVersion +
                '\n升级内容：' +
                json.data.upgradeContent
            )
          }
        }
      })
